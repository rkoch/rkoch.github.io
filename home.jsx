        ...
        <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.15fr 0.85fr', gap: 56, alignItems: 'center', minHeight: 'min(78vh, 720px)' }}>
          ...
          <Reveal delay={200}>
            <div style={{ position: 'relative', maxWidth: 420, marginLeft: 'auto' }}>
              ...
              <div style={{ position: 'relative', borderRadius: 6, overflow: 'hidden', border: '1px solid var(--line)', background: 'var(--card)' }}>
                <img src="assets/remo.jpg" alt="Remo Koch" style={{ width: '100%', aspectRatio: '1/1', objectFit: 'cover', objectPosition: 'top center' }} />
